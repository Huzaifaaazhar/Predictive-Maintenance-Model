...
## The LSTM model outperformed other models in terms of R-squared and RMSE. Feature selection and preprocessing significantly improved model performance. The developed pipeline provides insights into engine health monitoring and predictive maintenance.
